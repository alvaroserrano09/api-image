...
describe('Create Task', () => {
    it('Should create a task', async () => {
        const input = '/output/image1/1024/f322b730b2322387da77e1c519c7ffef4fc2.jpg';
        const taskRepository= new MongoTasksRepository();
        const createTaskSpy = jest.spyOn(taskRepository, 'save').mockImplementation(async (task: Task) => TASK_EXAMPLE);
